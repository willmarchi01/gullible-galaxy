...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-20 justify-center items-center leading-relaxed relative z-10">
        ...
        <h2 className="text-[#ff5757] text-center text-xl hero_subtitle md:text-2xl">
